...
if [ "$#" -ne 8 ];
  then
    echo "Usage: genes_GRCh38_file.gtf segmental_duplication.bed centromeres.txt.gz ouput_CDS_bed_file.bed
...
echo "Centromere file has been processed and send the output to " $CENTROMERES_SORTED_OUTPUT_FILE
