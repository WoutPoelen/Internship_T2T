...
bedtools_output_directory="/ifs/data/research/projects/wout/projects/wp1_depth/data/structural_varation_multiple_samples/intersect_genes_non_syntenic_SV_T2T"
